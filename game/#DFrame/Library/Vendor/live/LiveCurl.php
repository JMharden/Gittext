...
class LiveCurl
{
    // const GATEWAY = "https://shq-api-test.51fubei.com/gateway";      // 测试地址
    const GATEWAY = "https://shq-api.51fubei.com/gateway";              // 正式地址 
    const PAYPAGE = "https://shq-api.51fubei.com/paypage";              // 正式支付地址
