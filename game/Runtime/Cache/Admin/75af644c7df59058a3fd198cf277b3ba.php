...
<html lang="zh">
	...
	<body>
		...
		<div class="centercontent">
			<div class="pageheader notab"><h1 class="pagetitle">用户反馈</h1></div><!--pageheader-->
<div id="contentwrapper" class="contentwrapper lineheight21">
    <div class="tableoptions">
        <form method="post"> 
            ...
            用户ID: <input type="text" name="user_id" value="<?php echo ($_GET['user_id']); ?>" class="smallinput" style="width:100px;"/>
            用户昵称: <input type="text" name="nickname" value="<?php echo ($_GET['nickname']); ?>" class="smallinput" style="width:230px;"/>
