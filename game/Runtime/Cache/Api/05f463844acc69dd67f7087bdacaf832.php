		...
		<script>
		  ...
		  //   $("#receive").click(function(){
			 ...
			 //     $.ajax({
				...
				//         data:{'status':2,'uid':[80,81],'result':[111,521],'game_id':666},
			 //       	    success:function(data){
			 //              console.log(data);
				//         },
				// 		error:function(data){
		    ...
		    $("#receive").click(function(){
			    ...
			    // $("#click").text("is click"); 
			     ...
			     $.ajax({
				        type: "post",
				        dataType: "json",
				        url: url+"index.php?m=Index&c=index&a=joinClub",
				        data:{'club_id':5,'club_name':'lives','declaration':'无敌是多么多么无敌','area':'深圳','create_fee':500,'create_number':600},
			       	    success:function(data){
			              console.log(data);
				        },
						error:function(data){
