...
<script type="text/javascript">	
				...
				<div class="notice">
					...
					<div class="notice_table_wrap">
						...
						<div class="notice_table">
							<h6 class="all_tx">已获得佣金:<span class="ye_txAmount"><?php echo ($user["expense"]); ?></span>金币</h6>
							
                      
							<div class="notice_table_table"><table><tbody>
							  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td class="td-left"><i><?php echo ($vo["money"]); ?></i>金币</td><td class="td-middle">来自id:<?php echo ($vo["buyer_id"]); ?></td><td class="td-right"><?php echo (date("m-d H:i:s",$vo["create_time"])); ?></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
							</tbody></table></div>
                      
                       
							 	
						</div>
						 <div class="page" style=" padding:5px;color:rgb(167, 73, 56);margin-left: 15px;text-align:center;">
	...
	<div class="footer">
				<ul class="footer_ul">
                    ...
                    <li class="footer_li footer_li_4  footer_li_active">
                      <span></span><p>佣金</p>
                    </li>
                    </a>
                    <a href="/index.php?m=&c=index&a=kefu">
                    <li class="footer_li footer_li_5" style="margin-top: -20px;">
                      <span></span><p>客服</p>
                    </li>
                    </a>
				</ul>
