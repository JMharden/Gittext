...
<body style="width: 100%;height: 100%;background-color: #a54a37">
...
<script type="text/javascript">	
 ...
 <img src="<?php echo ($img); ?>?<?php echo time();?>" width="100%" height="100%" style="max-width:640px;max-height: 100%;margin-top: 6%;">
 </div>
<div class="footer">
                <ul class="footer_ul">
                    <a href="/">
