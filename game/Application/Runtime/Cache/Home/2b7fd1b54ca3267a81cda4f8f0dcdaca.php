...
<script type="text/javascript">	
			...
			<div class="withdraw_deposit_success">-->
				<div class="notice">
					...
					<div class="notice_table_wrap">
						...
						<div class="tx_fir_page">
							<a href="/index.php?m=&c=index&a=withdraw" style="color:rgb(167, 73, 56);"><p class="dh_btn">查看兑换记录</p></a>
							<div class="people_num"><p>一级用户： <span><?php echo ($data["f1"]); ?>人</span></p><p>二级用户： <span><?php echo ($data["f2"]); ?>人</span></p><p>三级用户： <span><?php echo ($data["f3"]); ?>人</span></p></div>
							<div class="more_game_wrap">
								<div class="more_game">
									<h5>更多游戏</h5>
									<div class="more_game_inner"><ul class="game_ul"><li>幸运大转盘<a class="go_game" go_ssc="" href="#">马上玩</a></li><li>QQ同时在线人数<a class="go_game" go_ssc="" href="http://www.ulikejob.com/index.php?state=3202">马上玩</a></li></ul></div>
								</div>
							</div>
						</div>					
						<!--提现记录列表-->
						<div class="notice_table  cpm-hide">
							<h6 class="all_tx">已提现余额:<span class="ye_txAmount">0</span>金币</h6>
							<div class="notice_table_table">
								<!--<table>
									<tr>
										<td class="td-left">现金<span>10000.00</span>元</td>
										<td class="td-middle td_middle_bg">已兑换</td>
										<td class="td-right">5月10日24:00:00</td>	
									</tr>
								</table>-->
							</div>
	...
	<div class="footer">
				<ul class="footer_ul">
                    ...
                    <li class="footer_li footer_li_2  footer_li_active">
                     <span></span><p>提现</p>      
                    </li>
                    </a>
