...
<div id="contentwrapper" class="contentwrapper lineheight21">
  ...
  <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
    <thead>
      <tr>
        <th class="head1" colspan="2">今日盈亏</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>用户手头余额</td>
        <td><?php echo ($user_in); ?></td>
      </tr>
      <tr>
        <td>今日收入</td>
        <td><?php echo ($today_in); ?></td>
      </tr>
      <tr>
        <td>用户下单金额</td>
        <td><?php echo ($xiadan); ?></td>
      </tr>
      <tr>
        <td>用户总收益</td>
        <td>中奖:<?php echo ($ying); ?> 佣金:<?php echo ($today_win_ext); ?> 合计:<?php echo ($ying + $today_win_ext); ?></td>
      </tr>
      <tr>
        <td>今日支出</td>
  ...
  <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
    <thead>
      <tr>
        <th class="head1" colspan="2">昨日盈亏</th>
      </tr>
    </thead>
    <tbody>
      <tr>
  ...
  <!-- <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
    <thead>
      <tr>
        <th class="head1" colspan="2">前日盈亏</th>
      </tr>
    </thead>
    <tbody>
      <tr>
